...
print(f"Dataset config file: {DATA_CONFIG}")
print(f"Current working directory: {os.getcwd()}")
print(f"Using absolute path: {os.path.abspath(DATA_CONFIG)}")
...
def get_dataset_list(dataset_names: Optional[list[str]], dataset_dir: str) -> list["DatasetAttr"]:
    ...
    if dataset_dir == "ONLINE":
        ...
        try:
            ...
            if len(dataset_names) != 0:
                # Create default dataset_info with common dataset definitions
                dataset_info = {
                    "alpaca": {
    ...
    for name in dataset_names:
        ...
        # Add on-the-fly definitions for common datasets if they don't exist
